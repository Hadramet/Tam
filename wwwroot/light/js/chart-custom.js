...
var options = {
    ...
    xaxis: {
        type: "datetime",
        categories: [
            "2018-08-19T00:00:00", "2018-09-19T01:30:00", "2018-10-19T02:30:00", "2018-11-19T01:30:00",
            "2018-12-19T01:30:00"
        ],
    },
    tooltip: {
...
getDayWiseTimeSeries(new Date("11 Feb 2017 GMT").getTime(),
    10,
    {
        min: 10,
        max: 90
...
var options = {
    ...
    series: [
        {
            name: "Bubble1",
            data: generateData(new Date("11 Feb 2017 GMT").getTime(),
                10,
                {
                    min: 10,
                    max: 60
        ...
        am4core.ready(function() {
            ...
            var countries = {
                ...
                "BA": {
                    ...
                    "continent": "Europe",
                    "maps": [
                        "bosniaHerzegovinaLow", "bosniaHerzegovinaHigh", "bosniaHerzegovinaCantonsLow",
                ...
                "DO": {
                    ...
                    "continent": "North America",
                    "maps": [
                        "dominicanRepublicLow", "dominicanRepublicHigh", "dominicanRepublicMuniLow",
                ...
                "US": {
                    ...
                    "continent": "North America",
                    "maps": [
                        "usaLow", "usaHigh", "usaTerritoriesLow", "usaTerritoriesHigh", "usaTerritories2Low",
                        "usaTerritories2High"
                    ]
                },
                "UY": {
...
if (jQuery("#apex-line-area").length) {
    var options = {
        ...
        xaxis: {
            type: "datetime",
            categories: [
                "2018-09-19T00:00:00", "2018-09-19T01:30:00", "2018-09-19T02:30:00", "2018-09-19T03:30:00",
...
if (jQuery("#apex-scatter-chart").length) {
    var options = {
        ...
        colors: ["#ff4545", "#1ee2ac", "#ffdd31"],
        series: [
            {
                name: "SAMPLE A",
                data: [
                    [16.4, 5.4], [21.7, 2], [10.9, 0], [10.9, 8.2], [16.4, 0], [16.4, 1.8], [13.6, 0.3], [13.6, 0],
                    [29.9, 0], [27.1, 2.3], [16.4, 0], [13.6, 3.7], [10.9, 5.2], [16.4, 6.5], [10.9, 0], [24.5, 7.1],
                    [10.9, 0], [8.1, 4.7]
                ]
            }, {
                name: "SAMPLE B",
                data: [
                    [36.4, 13.4], [1.7, 11], [1.9, 9], [1.9, 13.2], [1.4, 7], [6.4, 8.8], [3.6, 4.3], [1.6, 10],
                    [9.9, 2], [7.1, 15], [1.4, 0], [3.6, 13.7], [1.9, 15.2], [6.4, 16.5], [0.9, 10], [4.5, 17.1],
                    [10.9, 10], [0.1, 14.7]
                ]
            }, {
                name: "SAMPLE C",
                data: [
                    [21.7, 3], [23.6, 3.5], [28, 4], [27.1, 0.3], [16.4, 4], [13.6, 0], [19, 5], [22.4, 3], [24.5, 3],
                    [32.6, 3], [27.1, 4], [29.6, 6], [31.6, 8], [21.6, 5], [20.9, 4], [22.4, 0], [32.6, 10.3],
                    [29.7, 20.8]
                ]
            }
        ],
...
if (jQuery("#apex-radialbar-chart").length) {
    var options = {
        ...
        colors: ["#ff4545", "#1ee2ac", "#ffdd31", "#00d0ff"],
...
if (jQuery("#apex-pie-chart").length) {
    var options = {
        ...
        colors: ["#ff4545", "#1ee2ac", "#ffdd31", "#00d0ff", "#ff7750"],
        responsive: [
            {
                breakpoint: 480,
                options: {
...
if (jQuery("#am-simple-chart").length) {
    am4core.ready(function() {
        ...
        chart.colors.list = [am4core.color("#ff4545"),];
...
if (jQuery("#am-columnlinr-chart").length) {
    am4core.ready(function() {
        ...
        lineSeries.stroke = am4core.color("#ff4545");
...
if (jQuery("#am-polarscatter-chart").length) {
    am4core.ready(function() {
        ...
        chart.colors.list = [am4core.color("#ff4545"), am4core.color("#1ee2ac"), am4core.color("#00d0ff")];
...
if (jQuery("#am-3dpie-chart").length) {
    am4core.ready(function() {
        ...
        series.colors.list = [
            am4core.color("#ff4545"), am4core.color("#1ee2ac"), am4core.color("#ffdd31"),
            am4core.color("#ff7750"), am4core.color("#00d0ff"), am4core.color("#a09e9e")
        ];
...
if (jQuery("#am-layeredcolumn-chart").length) {
    am4core.ready(function() {
        ...
        chart.colors.list = [am4core.color("#1ee2ac"), am4core.color("#ff4545")];
...
if (jQuery("#morris-bar-chart").length) {
    Morris.Bar({
        ...
        ykeys: ["y", "z", "a"],
        labels: ["Y", "Z", "A"],
        barColors: ["#ff4545", "#1ee2ac", "#ff7750"],
...
if (jQuery("#home-perfomer-chart").length) {
    var options = {
        ...
        colors: ["#ff4545", "#e64141", "#ff4545", "#00d0ff"],
        plotOptions: {
            radialBar: {
                dataLabels: {
                    name: {
...
if (jQuery("#menu-overtime-chart").length) {
    am4core.ready(function() {
        ...
        dateAxis.tooltip.adapter.add("x",
            function(x, target) {
                return am4core.utils.spritePointToSvg({ x: chart.plotContainer.pixelX, y: 0 }, chart.plotContainer).x +
...
if (jQuery("#menu-chart-01").length) {
    am4core.ready(function() {
        ...
        pieSeries.colors.list = [
            am4core.color("#FD6C9E"), am4core.color("#1be1b3"), am4core.color("#f4b72a"),
            am4core.color("#3f79f1"), am4core.color("#ff4545"), am4core.color("#e64141"), am4core.color("#1ee2ac")
        ];
...
if (jQuery("#menu-chart-04").length) {
    am4core.ready(function() {
        ...
        range.value = 90.4;
        range.grid.stroke = am4core.color("#ff4545");
...
if (jQuery("#home-Groth-chart").length) {
    am4core.ready(function() {
        ...
        categoryAxis.renderer.labels.template.adapter.add("dx",
            function(dx, target) {
...
if (jQuery("#progress-chart-2").length) {
    ...
    document.addEventListener("ChangeColorMode",
        function(e) {
